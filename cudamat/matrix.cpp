///////////////////////////////////////////////////////////////////
// NOTES BY IS:
// I had problems linking because the trio
// #define CBLAS_GEMM cblas_sgemm
// #define CBLAS_SCAL cblas_sscal
// #define CBLAS_AXPY cblas_saxpy
// were not linked to. It was annoying, so I decided to comment all of these instances
// out and to append them with assert(0); so if you find all assert(0)'s uncomment their
// adjacent lines, the code will revert to its original state.
